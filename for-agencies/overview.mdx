...
| Scoped key (`mcp_`) | `Authorization: Bearer mcp_...` | Exactly the [scopes](/mcp/authentication#scopes) you grant — one location or agency-wide, read or write per family | An integration or AI agent that needs one capability; also the MCP credential |
