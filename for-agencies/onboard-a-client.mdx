  ...
  <Step title="Get the loader snippet" icon="code" titleType="h3">
    ...
    ```json
    {
      ...
      "data": {
        ...
        "script_snippet": "<script>!function(){var e=[];window.mythic={init:function(t,n){return e.push([\"init\",t,n]),window.mythic},q:e};[\"capture\",\"pageview\",\"identify\",\"alias\",\"reset\",\"opt_in\",\"opt_out\"].forEach(function(t){window.mythic[t]=function(){return e.push([t].concat(Array.prototype.slice.call(arguments))),window.mythic}});var t=document.createElement(\"script\");t.async=!0;t.src=\"https://api.adberserk.com/cdn/m.js\";(document.head||document.body).appendChild(t)}();\nmythic.init(\"pk_example000000000000000000000000\");</script>"
      }
    }
    ```
