...
//  { platform: 'posthog', experimentId: 'pricing-page-test',
//    variationId: 'variant-b' }]
```

For PostHog, `experimentId` is the feature-flag key and `variationId` is the variant. Only experiment-linked and multivariate flags are returned — boolean feature flags are rollouts, not tests.
