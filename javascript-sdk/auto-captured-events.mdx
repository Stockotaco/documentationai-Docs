...
| `$experiment_viewed` | A third-party A/B tool (Convert.com) bucketed this visitor — once per session per assignment, with `experiment_id`, `variation_id`, `variation_name`, `first_exposure` | `capture_experiments` |
