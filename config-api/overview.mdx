...
the init config. Match the signal list exactly if you hand-roll it: a gate that
misses one lets the request through for a visitor the SDK would have honoured.
