...
| Value | Cadence | Schedule |
|-------|---------|----------|
| `24h` | Once daily | 02:00 |
| `12h` | Every 12 hours | 00:00, 12:00 |
| `6h` | Every 6 hours | 00:00, 06:00, 12:00, 18:00 |
| `manual` | No automatic syncs | — |

You send the cadence, not a cron expression. Internally these become Quartz cron (six fields, seconds first) because that is what Airbyte's scheduler accepts; a five-field Unix expression is rejected outright.
