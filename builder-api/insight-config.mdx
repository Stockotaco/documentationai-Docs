...
| `funnel`  | `funnel` | 2–10 `steps`, optional `window`, `breakdown` | step bars with conversion rates |
...
| `meta` | resolved window, interval, breakdown settings, `sql_ms`, `rows_read` | same |
